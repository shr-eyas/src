...
Y_DESIRED = -0.000979858440219944
...
class TrialManager:
    ...
    def run(self):
        ...
        # ✅ Ensure robot starts from home pose
        rospy.loginfo("Moving to home pose before starting trials...")
        self.switch(['joint_position_controller'], [])
        ...
        for Ky in KY_VALUES:
            ...
            for trial in range(1, TRIALS_PER_KY + 1):
                ...
                self.switch(['eoi_controller'], ['joint_position_controller'])
                ...
                self.switch(['joint_position_controller'], ['eoi_controller'])
